        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <span class="tools pull-right">
                    <a href="/type/create" class="fa fa-plus"></a>
                    ...
                    <table class="table table-bordered table-striped table-condensed cf">
                        ...
                        foreach ($list as $key => $val)
                        {
                            ...
                            <tr data-id="<?=$val['id']?>">
                                ...
                                <td><?=$val['type_name']?></td>
                                <td>
                                    <a href="/type/update?id=<?=$val['id']?>" class="btn btn-primary tooltips" data-toggle="tooltip" data-placement="top" data-original-title="编辑"><i class="fa fa-cog"></i></a>
                                    ...
                                    <a class="btn btn-danger tooltips" data-toggle="tooltip" data-placement="top" data-original-title="删除" data-method="type"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                            <?php
                        }
