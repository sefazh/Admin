                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal adminex-form" id="typeCreateForm" method="post">
                                    <div class="form-group ">
                                        <label for="cat_name" class="control-label col-lg-3 col-sm-3">type_name</label>
                                        <div class="col-lg-4 col-sm-4">
                                            <input class=" form-control" id="type_name" name="type_name" type="text" value="<?=$row['type_name']?>" />
                                        </div>
                                    </div>
