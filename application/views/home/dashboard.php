...
<head>
    ...
    <?php include_once VIEWPATH."include/icheck/icheck-css.php"?>

    <?php include_once VIEWPATH."include/calendar/calendar-css.php"?>

    <?php include_once VIEWPATH."include/morris-chart/morris-chart-css.php"?>
...
<section>
    ...
    <div class="main-content" >
        ...
        <div class="page-heading">
            ...
            <?php include_once VIEWPATH."/module/state-info.php"?>
        </div>
        <!-- page heading end-->
                            ...
                            <ul class="goal-progress">
                                <li>
                                    <div class="prog-avatar">
                                        <img src="<?php echo __PUBLIC__ ?>images/photos/user1.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="<?php echo __PUBLIC__ ?>images/photos/user2.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="<?php echo __PUBLIC__ ?>images/photos/user3.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="<?php echo __PUBLIC__ ?>images/photos/user4.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="<?php echo __PUBLIC__ ?>images/photos/user5.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                            <a href="#">Hoffman Doe</a> - Support
                        ...
                        <div class="panel-body">
                            <div class="media usr-info">
                                <a href="#" class="pull-left">
                                    <img class="thumb" src="<?php echo __PUBLIC__ ?>images/photos/user2.png" alt=""/>
                                </a>
...
<?php include_once VIEWPATH."include/easy-pie-chart/easy-pie-chart-js.php"?>

<?php include_once VIEWPATH."include/sparkline-chart/sparkline-chart-js.php"?>

<?php include_once VIEWPATH."include/icheck/icheck-js.php"?>

<?php include_once VIEWPATH."include/jquery-flot/jquery-flot.php"?>

<?php include_once VIEWPATH."include/morris-chart/morris-chart-js.php"?>

<?php include_once VIEWPATH."include/calendar/calendar-js.php"?>

<?php include_once VIEWPATH."include/common/common-js.php"?>

<?php include_once VIEWPATH."include/dashboard-charts/dashboard-charts-js.php"?>
